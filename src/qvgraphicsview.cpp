...
const QJsonObject QVGraphicsView::getSessionState() const
{
    ...
    QJsonArray transformValues;
    transformValues.append(static_cast<int>(transform.m11()));
    transformValues.append(static_cast<int>(transform.m22()));
    transformValues.append(static_cast<int>(transform.m21()));
    transformValues.append(static_cast<int>(transform.m12()));
